...
export function MujeresPage() {
  const groupData = {
    title: 'Ministerio de Mujeres',
    subtitle: 'Mujeres de fe y propósito',
    description: 'Un ministerio dedicado a empoderar a las mujeres en su caminar con Dios. Nos enfocamos en el crecimiento espiritual, el desarrollo del liderazgo femenino, el fortalecimiento de la familia y el servicio a la comunidad, equipando a las mujeres para ser instrumentos de bendición en sus hogares y sociedad.',
    ...
    leader: {
      ...
      role: 'Director Ministerio de Mujeres',
      bio: 'Pastor principal con una pasión profunda por empoderar a las mujeres en su caminar con Dios y el desarrollo del liderazgo femenino.',
    ...
    activities: [
      {
        ...
        description: 'Encuentros de intercesión y comunión espiritual',
        schedule: 'Martes 9:00 AM - 11:00 AM'
      },
      {
        icon: BookOpen,
        title: 'Estudio Bíblico Femenino',
        description: 'Profundización en la Palabra desde perspectiva femenina',
        schedule: 'Jueves 7:00 PM - 8:30 PM'
      },
      {
        icon: Heart,
        title: 'Ministerio de Consolación',
        description: 'Apoyo y acompañamiento a mujeres en necesidad',
        schedule: 'Según necesidades específicas'
      },
      {
        icon: Target,
        title: 'Talleres de Desarrollo',
        description: 'Capacitación en habilidades y liderazgo femenino',
        schedule: 'Primer sábado del mes 2:00 PM'
      }
    ],
    upcomingEvents: [
      {
        title: 'Retiro de Mujeres "Renueva tu Esperanza"',
        date: '2025-03-15',
        time: '9:00 AM - 5:00 PM',
        location: 'Centro de Retiros Bethel',
        description: 'Día de renovación espiritual, talleres y comunión entre mujeres de fe.'
      },
      {
        title: 'Conferencia de Liderazgo Femenino',
        date: '2025-02-22',
        time: '6:00 PM - 9:00 PM',
        location: 'Auditorio Principal',
        description: 'Enseñanza sobre el liderazgo de la mujer en la familia y la iglesia.'
      }
    ],
    resources: [
      'Biblioteca de libros sobre liderazgo femenino',
      'Material de estudio bíblico especializado',
      'Espacio para reuniones y actividades',
      'Red de mentoras experimentadas'
    ]
  };
                ...
                <div className="card">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Iglesia Vida Nueva - Salón de Mujeres</span>
                    </div>
                    <div className="flex items-center">
