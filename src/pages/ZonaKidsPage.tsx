...
export function ZonaKidsPage() {
  const groupData = {
    title: 'Zona Kids',
    subtitle: 'Niños de 3 a 12 años',
    description: 'Un lugar seguro y divertido donde los niños pueden aprender sobre el amor de Dios a través de historias bíblicas, juegos, música y actividades creativas. Formamos pequeños discípulos con corazón de adoradores.',
    ...
    leader: {
      ...
      role: 'Coordinador Zona Kids',
      bio: 'Pastor principal con una pasión profunda por la educación cristiana infantil y la formación de pequeños discípulos con corazón de adoradores.',
    ...
    activities: [
      {
        ...
        description: 'Historias bíblicas contadas de manera creativa y divertida, con lecciones adaptadas para cada edad',
        schedule: 'Domingos 9:00 AM - 10:00 AM'
      },
      {
        icon: Music,
        title: 'Alabanza Infantil',
        description: 'Canciones alegres, coreografías sencillas y momentos especiales de adoración',
        schedule: 'Domingos 10:00 AM - 10:30 AM'
      },
      {
        icon: Gamepad2,
        title: 'Juegos y Dinámicas',
        description: 'Actividades lúdicas, juegos cooperativos y dinámicas que enseñan valores cristianos',
        schedule: 'Sábados 3:00 PM - 5:00 PM'
      },
      {
        icon: Heart,
        title: 'Servicio Comunitario Kids',
        description: 'Proyectos de ayuda apropiados para niños donde aprenden el valor de servir a otros',
        schedule: 'Una vez al mes'
      }
    ],
    upcomingEvents: [
      {
        title: 'Campamento Zona Kids 2025',
        date: '2025-03-15',
        time: '8:00 AM - 5:00 PM',
        location: 'Centro Recreativo El Paraíso',
        description: 'Tres días increíbles de aventuras, juegos, talleres creativos y momentos especiales con Dios.'
      },
      {
        title: 'Teatro Bíblico: "Daniel y los Leones"',
        date: '2025-02-28',
        time: '6:00 PM - 7:30 PM',
        location: 'Auditorio Principal',
        description: 'Los niños de Zona Kids presentarán la emocionante historia de Daniel en el foso de los leones.'
      }
    ],
    resources: [
      'Material didáctico semanal personalizado',
      'Videos educativos de historias bíblicas',
      'Canciones y coreografías para practicar en casa',
      'Guías para el devocional familiar'
    ]
  };
                ...
                <div className="card">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Iglesia Vida Nueva - Salón Zona Kids</span>
                    </div>
                    <div className="flex items-center">
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Te invitamos a ser parte de esta comunidad donde tu hijo podrá crecer, servir y impactar vidas.
          </p>
