            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p>{user?.updated_at ? new Date(user.updated_at).toLocaleString() : 'No disponible'}</p>
                </div>
              </div>
            </div>
          )}
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="flex items-center">
                        <input 
                          ...
                          defaultChecked={currentEvent?.requires_rsvp}
                        />
                        <label htmlFor="requires_rsvp" className="ml-2 block text-sm text-gray-900">
                    ...
                    {sermons.map((sermon) => (
                      <tr key={sermon.id}>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-10 w-10">
                              <img className="h-10 w-10 rounded object-cover" src={sermon.thumbnail_url} alt={sermon.title} />
                            </div>
                            <div className="ml-4">
                  ...
                  <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="has_transcript" className="ml-2 block text-sm text-gray-900">
                        ...
                        <button 
                          ...
                          onClick={() => {
                            ...
                            const sermonData = currentSermon || {
                              ...
                              tags: ['fe', 'esperanza'],
                              video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
                              audio_url: '/audio/sermon-new.mp3',
                    ...
                    {blogPosts.map((post) => (
                      <tr key={post.id}>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-10 w-10">
                              <img className="h-10 w-10 rounded object-cover" src={post.cover_image} alt={post.title} />
                            </div>
                            <div className="ml-4">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <img className="h-6 w-6 rounded-full mr-2" src={post.author.avatar_url} alt={post.author.name} />
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input 
                            type="date" 
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            defaultValue={currentBlogPost?.published_at}
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="https://ejemplo.com/imagen.jpg"
                          defaultValue={currentBlogPost?.cover_image}
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input 
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="5"
                            defaultValue={currentBlogPost?.read_time}
                          />
                        </div>
                        <div>
