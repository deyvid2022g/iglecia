...
export function SermonsPage() {
  ...
  const sermons = [
    ...
    },
    {
      ...
      date: '2025-01-20',
      duration: '42:10',
      thumbnail_url: 'https://images.pexels.com/photos/289586/pexels-photo-289586.jpeg?auto=compress&cs=tinysrgb&w=800&h=450&fit=crop',
      ...
      video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
      audio_url: '/audio/sermon-003.mp3',
      has_transcript: true,
      view_count: 1567
    },
    {
      ...
      date: '2025-01-27',
      duration: '29:45',
      thumbnail_url: 'https://images.pexels.com/photos/1000445/pexels-photo-1000445.jpeg?auto=compress&cs=tinysrgb&w=800&h=450&fit=crop',
      ...
      video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
      audio_url: '/audio/sermon-004.mp3',
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex items-center text-gray-600 text-sm space-x-4 mb-3">
                        ...
                        <span>•</span>
                        <span>{sermon.view_count.toLocaleString()} visualizaciones</span>
                      </div>
                    </div>
