...
export function AlabanzaPage() {
  const groupData = {
    ...
    subtitle: 'Adorando en espíritu y verdad',
    description: 'Un ministerio dedicado a la adoración y alabanza a Dios a través de la música, el canto y la expresión artística. Nos enfocamos en formar músicos y cantantes que puedan servir en la iglesia, desarrollando talentos musicales y promoviendo una adoración auténtica y poderosa.',
    color: 'bg-purple-100 text-purple-800 border-purple-200',
    image: 'https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop',
    leader: {
      name: 'Pastor Musical Carlos Mendoza',
      role: 'Director Ministerio de Alabanza',
      bio: 'Músico profesional con más de 20 años de experiencia en dirección musical y formación de equipos de alabanza en diferentes iglesias.',
      image: 'https://images.pexels.com/photos/1587009/pexels-photo-1587009.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop'
    },
    activities: [
      {
        icon: Music,
        title: 'Ensayos de Alabanza',
        description: 'Práctica semanal del equipo de alabanza',
        schedule: 'Miércoles 7:00 PM - 9:00 PM'
      },
      {
        icon: BookOpen,
        title: 'Clases de Música',
        description: 'Enseñanza de instrumentos y técnica vocal',
        schedule: 'Sábados 2:00 PM - 4:00 PM'
      },
      {
        icon: Users,
        title: 'Ministerio en Servicios',
        description: 'Participación en servicios dominicales',
        schedule: 'Domingos 9:00 AM y 6:00 PM'
      },
      {
        icon: Target,
        title: 'Talleres de Adoración',
        description: 'Formación en adoración y liderazgo musical',
        schedule: 'Primer sábado del mes 10:00 AM'
      }
    ],
    upcomingEvents: [
      {
        ...
        description: 'Noche especial de adoración con invitados especiales y presentaciones del ministerio de alabanza.'
      },
      {
        ...
        description: 'Aprende a componer canciones de adoración y desarrolla tu creatividad musical.'
      }
    ],
    resources: [
      'Instrumentos musicales disponibles',
      'Partituras y acordes de canciones',
      'Sistema de sonido profesional',
      'Biblioteca de música cristiana'
    ]
  };
                ...
                <div className="card">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Iglesia Vida Nueva - Sala de Música</span>
                    </div>
                    <div className="flex items-center">
