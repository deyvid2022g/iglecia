...
export function FamiliasPage() {
  const groupData = {
    title: 'Ministerio de Familias',
    subtitle: 'Fortaleciendo los lazos familiares',
    description: 'Un ministerio dedicado a fortalecer los vínculos familiares a través de la enseñanza bíblica, actividades recreativas y programas de apoyo que promueven la unidad, el amor y los valores cristianos en cada hogar.',
    color: 'bg-orange-100 text-orange-800 border-orange-200',
    image: 'https://images.pexels.com/photos/1128318/pexels-photo-1128318.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop',
    leader: {
      name: 'Pastor Miguel Hernández',
      role: 'Coordinador Ministerio de Familias',
      bio: 'Con más de 12 años de experiencia en ministerio familiar, Miguel se especializa en consejería familiar y programas de fortalecimiento del hogar cristiano.',
    ...
    activities: [
      {
        ...
        description: 'Talleres de crianza con principios bíblicos',
      ...
      },
      {
        ...
        schedule: 'Segundo domingo del mes 3:00 PM'
      },
      {
        icon: Heart,
        title: 'Consejería Familiar',
        description: 'Apoyo y orientación para familias',
        schedule: 'Miércoles 7:00 PM - 9:00 PM'
      },
      {
        icon: Target,
        title: 'Devocionales Familiares',
        description: 'Recursos para el culto en el hogar',
        schedule: 'Material semanal disponible'
      }
    ],
    upcomingEvents: [
      {
        title: 'Campamento Familiar de Verano',
        date: '2025-03-20',
        time: '8:00 AM - 6:00 PM',
        location: 'Centro Recreativo Familiar',
        description: 'Fin de semana de diversión y fortalecimiento familiar con actividades para todas las edades.'
      },
      {
        title: 'Taller de Comunicación Familiar',
        date: '2025-02-25',
        time: '9:00 AM - 12:00 PM',
        location: 'Aula de Conferencias',
        description: 'Aprende técnicas efectivas de comunicación para mejorar las relaciones familiares.'
      }
    ],
    resources: [
      'Guías de devocionales familiares semanales',
      'Biblioteca de recursos para padres',
      'Programa de mentoría para familias nuevas',
      'Talleres de finanzas familiares'
    ]
  };
